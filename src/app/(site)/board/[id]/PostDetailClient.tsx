...
function categoryClass(cat: string) {
  switch (cat) {
    case '성공사례': return 'sejin-cat-success'
    case '정책자금': return 'sejin-cat-fund'
    case '인증지원': return 'sejin-cat-cert'
    default: return 'sejin-cat-fund'
  }
}
    ...
    return (
      <div className="sp-section">
        <div className="sp-layout" style={{ justifyItems: 'center', padding: '80px 20px' }}>
          <div style={{ width: 40, height: 40, border: '3px solid rgba(212,165,116,0.3)', borderTopColor: '#D4A574', borderRadius: '50%', animation: 'spin 1s linear infinite' }} />
  ...
  return (
    <>
          ...
          <div className="sp-main">
            ...
            <div className="sp-card">
                ...
                <div className="sp-meta">
                  ...
                  {post.금액 && (
                    <div className="sp-meta-item">
                      ...
                      <span style={{ fontWeight: 700, color: 'var(--sejin-primary)' }}>{post.금액}</span>
                    </div>
                  )}
                  <div className="sp-meta-item">
              ...
              <div className="sp-cta-section">
                ...
                <a href="/contact#sejin-contact-form" className="sp-cta-btn">
                    ...
                    <Link key={r.id} href={`/board/${r.id}`} className="sp-related-card group">
                      <div className="sp-related-thumb">
                        {r.썸네일 ? (
                          ...
                          <div style={{ width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, var(--sejin-primary-pale) 0%, var(--sejin-primary-light) 100%)' }}>
                            <span style={{ color: 'var(--sejin-primary)', fontSize: 13, fontWeight: 700, letterSpacing: 2 }}>세진</span>
                          </div>
                        )}
                      </div>
          ...
          <aside className="sp-sidebar">
            <div className="sp-sidebar-sticky">
              ...
              <div className="sp-sidebar-card">
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 12, fontSize: 14 }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    ...
                    <span style={{ color: 'var(--sejin-primary)', fontWeight: 600 }}>{post.카테고리}</span>
                  </div>
                  <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                  ...
                  {post.금액 && (
                    <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                      ...
                      <span style={{ color: 'var(--sejin-primary)', fontWeight: 700 }}>{post.금액}</span>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="sp-sidebar-card">
                ...
                <a href="tel:1877-0773" className="sp-phone-link">
      ...
      <div className="sp-mobile-bar">
        ...
        <a href="/contact#sejin-contact-form" className="sp-mobile-consult">
      ...
      {copied && (
        <div style={{
          ...
          padding: '12px 24px', background: 'var(--sejin-primary)', color: '#fff',
      ...
      <style jsx>{`
        ...
        /* 섹션 */
        .sp-section {
          background: linear-gradient(180deg, #FFFFFF 0%, var(--sejin-bg-ivory) 50%, #FFFFFF 100%);
        ...
        .sp-breadcrumb :global(a:hover) { color: var(--sejin-primary); }
        .sp-breadcrumb .current {
          color: var(--sejin-text-primary);
          font-weight: 500;
        }
        ...
        :global(.sejin-cat-success) { background: linear-gradient(135deg, #059669 0%, #10B981 100%); }
        :global(.sejin-cat-fund) { background: linear-gradient(135deg, #C4956A 0%, #D4A574 100%); }
        :global(.sejin-cat-cert) { background: linear-gradient(135deg, #D97706 0%, #F59E0B 100%); }
        ...
        .sp-meta-item svg { stroke: var(--sejin-primary-light); }
        ...
        .sp-body :global(h3) { font-size: 18px; color: var(--sejin-primary-dark); }

        .sp-body :global(strong) { color: var(--sejin-primary-dark); font-weight: 600; }
        ...
        .sp-body :global(blockquote) {
          margin: 24px 0;
          padding: 20px 25px;
          background: var(--sejin-primary-pale);
          border-left: 4px solid var(--sejin-primary);
        ...
        .sp-body :global(a) {
          color: var(--sejin-primary);
          text-decoration: underline;
          text-underline-offset: 2px;
        }
        .sp-body :global(a:hover) { color: var(--sejin-primary-dark); }
        ...
        .sp-cta-badge {
          display: inline-block;
          background: var(--sejin-gradient-primary);
          color: #fff;
          padding: 6px 18px;
          border-radius: 20px;
          font-size: 13px;
        ...
        .sp-cta-btn {
          ...
          text-decoration: none;
          transition: all 0.3s;
          box-shadow: var(--sejin-shadow-primary);
        }
        .sp-cta-btn:hover {
        ...
        .sp-related-card:hover {
          ...
          border-color: var(--sejin-primary-light);
        ...
        .sp-related-card:hover .sp-related-name { color: var(--sejin-primary); }
        ...
        .sp-phone-link svg { stroke: var(--sejin-primary); }
