    ...
    <>
      ...
      <section id="sejin-hero" className="sejin-hero">
        <div className="sejin-hero-container">
          {/* Left: Main Copy */}
          <div className="sejin-hero-content">
            <div className="sejin-hero-badge">
            ...
            <div className="sejin-hero-cta-group">
              ...
              <Link href="/fund" className="sejin-cta-ghost">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <p className="sejin-hero-disclaimer">
      ...
      <section id="sejin-interest" className="sejin-interest">
        <div className="sejin-section-container">
          ...
          <div className="sejin-rate-grid">
            {/* Card 1: Policy Fund (Highlight) */}
            <div className="sejin-rate-card highlight">
              <span className="sejin-essential-badge">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                  <polyline points="20 6 9 17 4 12"/>
                </svg>
                필수체크
              </span>
              <span className="sejin-card-badge">가장 저렴</span>

              <div className="sejin-card-icon">
              ...
              <h3 className="sejin-card-label">정책자금</h3>
              <div className="sejin-rate-percent">3.5%</div>
              <div className="sejin-rate-amount">350만원</div>
            </div>

            {/* Card 2: Bank Loan */}
            <div className="sejin-rate-card">
              <span className="sejin-card-top-badge">연 300만원 손실</span>
              ...
              <h3 className="sejin-card-label">은행 대출</h3>
              <div className="sejin-rate-percent">6.5%</div>
              <div className="sejin-rate-amount">650만원</div>
              <div className="sejin-rate-loss">연 300만원 손실</div>
            </div>

            {/* Card 3: Card Loan */}
            <div className="sejin-rate-card">
              <span className="sejin-card-top-badge">연 1,150만원 손실</span>
              ...
              <h3 className="sejin-card-label">카드론</h3>
              <div className="sejin-rate-percent">15%</div>
              <div className="sejin-rate-amount">1,500만원</div>
              <div className="sejin-rate-loss">연 1,150만원 손실</div>
            </div>
          </div>

          <p className="sejin-rate-note">※ 1년 기준, 1억원 대출 시 연간 이자 금액</p>

          {/* Highlight Message */}
          <div className="sejin-highlight-message">
            <div className="sejin-highlight-text">
              정책자금으로 최대<br/>
              <span className="emphasis">1,150만원</span>
              이자부담 절약가능
            </div>
            <p className="sejin-disclaimer">
          ...
          {/* CTA Button */}
          <div className="sejin-interest-cta">
            <Link href="/contact" className="sejin-cta-primary">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M9 11l3 3L22 4"/>
                <path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/>
      ...
      <section id="sejin-info" className="sejin-info">
        <div className="sejin-section-container">
          ...
          <div className="sejin-expert-grid">
            <div className="sejin-expert-card">
              <div className="sejin-expert-profile">
                <div className="sejin-expert-photo">
                  <Image src="/images/profile.jpg" alt="유현서 대표 컨설턴트" width={200} height={200} />
                </div>
                <h4 className="sejin-expert-name">유현서</h4>
                <p className="sejin-expert-role">기업심사관</p>
              </div>
      ...
      <section id="sejin-story" className="sejin-story">
        <div className="sejin-section-container">
          ...
          <div className="sejin-review-scroll-wrapper">
            <div className="sejin-review-scroll-container">
              {/* First Set */}
              <div className="sejin-review-card">
                <span className="sejin-review-industry">대전 제조업 대표님</span>
                <p className="sejin-review-text">다른 업체는 상담 후 연락이 두절되는 경우가 많았는데, 세진컨설팅은 처음부터 끝까지 책임감 있게 진행해주셔서 정말 신뢰할 수 있었습니다. 정책자금 받는 과정이 이렇게 안심되는 줄 몰랐어요.</p>
              </div>

              <div className="sejin-review-card">
                <span className="sejin-review-industry">세종 식품업 대표님</span>
                <p className="sejin-review-text">제가 직접 은행에 알아봤을 때는 5천만원 한도였는데, 세진컨설팅을 통해 정책자금을 알아보니 더 좋은 조건을 찾을 수 있었어요. 덕분에 사업 확장 계획을 앞당길 수 있었습니다.</p>
              </div>

              <div className="sejin-review-card">
                <span className="sejin-review-industry">천안 IT 대표님</span>
                <p className="sejin-review-text">정책자금 종류가 이렇게 많은지 몰랐어요. 저희 회사 상황에 딱 맞는 자금을 추천해주시고, 신청 절차까지 상세히 안내해주셔서 헤매지 않고 진행할 수 있었습니다.</p>
              </div>

              <div className="sejin-review-card">
                <span className="sejin-review-industry">공주 유통업 대표님</span>
                <p className="sejin-review-text">문의사항이 생길 때마다 빠르게 답변해주셔서 답답함이 없었어요. 다른 컨설팅 업체는 연락이 잘 안 되던데, 여기는 카톡으로도 실시간 소통이 가능해서 정말 편했습니다.</p>
              </div>

              <div className="sejin-review-card">
                <span className="sejin-review-industry">논산 건설업 대표님</span>
                <p className="sejin-review-text">솔직히 처음엔 반신반의했는데, 실제로 정책자금이 일반 대출보다 금리가 낮더라고요. 이자 부담이 확 줄어드니까 회사 운영이 훨씬 여유로워졌습니다.</p>
              </div>

              <div className="sejin-review-card">
                <span className="sejin-review-industry">아산 제조업 대표님</span>
                <p className="sejin-review-text">정책자금이 이렇게 금리가 낮고 조건이 좋은 줄 전혀 몰랐습니다. 일반 대출만 알고 있었는데, 세진컨설팅에서 정책자금의 장점을 하나하나 설명해주셔서 눈이 확 뜨였어요.</p>
              </div>

              <div className="sejin-review-card">
                <span className="sejin-review-industry">보령 서비스업 대표님</span>
                <p className="sejin-review-text">저희 회사 업종과 규모에 맞는 정책자금을 정확히 찾아주셨어요. 전문가의 노하우가 확실히 다르다는 걸 느꼈습니다. 혼자 알아봤으면 이런 좋은 조건의 자금은 못 찾았을 거예요.</p>
              </div>

              <div className="sejin-review-card">
                <span className="sejin-review-industry">서산 물류업 대표님</span>
                <p className="sejin-review-text">절차가 투명하고, 추가 비용이나 숨은 수수료 같은 게 전혀 없어서 믿고 맡길 수 있었어요. 처음부터 모든 과정을 명확하게 설명해주시니까 불안감이 없었습니다.</p>
              </div>

              <div className="sejin-review-card">
                <span className="sejin-review-industry">당진 도소매업 대표님</span>
                <p className="sejin-review-text">다른 업체는 전화 한 통으로 끝나는 느낌이었는데, 여기는 정말 세심하게 챙겨주셔서 감동했어요. 제 상황을 꼼꼼히 파악하고 최선의 방법을 찾아주려고 노력하시는 게 느껴졌습니다.</p>
              </div>

              <div className="sejin-review-card">
                <span className="sejin-review-industry">홍성 무역업 대표님</span>
                <p className="sejin-review-text">혼자 준비하다가 너무 복잡해서 포기하려던 참이었어요. 그런데 세진컨설팅에서 끝까지 함께 해주셔서 결국 정책자금 신청을 무사히 마칠 수 있었습니다. 정말 감사드립니다.</p>
              </div>
