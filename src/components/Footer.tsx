      ...
      <div className="sejin-footer-container">
        ...
        <div className="sejin-footer-main">
          ...
          <div className="sejin-footer-company">
            <div className="sejin-footer-logo">
              <img src="/images/logo-white.png" alt="세진컴퍼니 로고" />
            </div>
            ...
            <div className="sejin-footer-info">
              <div>
                <strong>상호</strong> 세진컴퍼니
              </div>
              <div>
                <strong>대표</strong> 유현서
              </div>
              <div>
                <strong>사업자번호</strong> 780-06-02033
              </div>
              <div>
                <strong>주소</strong> 대전광역시 서구 둔산로 73번길 22, 404호
                (둔산동, 블루샵)
              </div>
            </div>
          </div>
          ...
          <div className="sejin-footer-contact">
            ...
            <div className="sejin-contact-list">
              <div className="sejin-contact-item">
                ...
                <div>
                  <a href="tel:1877-0773" className="sejin-phone-highlight">
                    1877-0773
                  </a>
                </div>
              </div>
              ...
              <div className="sejin-contact-item">
                ...
                <div>
                  <a href="mailto:a01077457213@gmail.com">
                    a01077457213@gmail.com
                  </a>
                </div>
              </div>
            </div>
          ...
          <div className="sejin-footer-links">
            ...
            <ul className="sejin-footer-nav">
              ...
              <li>
                <Link href="/fund">정책자금</Link>
              </li>
              <li>
                <Link href="/certification">인증지원</Link>
              </li>
              <li>
                <Link href="/success">성공사례</Link>
              </li>
              <li>
                <Link href="/contact#sejin-contact-form">무료심사</Link>
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="sejin-partnership-link">
            ...
            >
              <img
                ...
                alt="업무협약 아이콘"
                className="sejin-partnership-icon"
              />
              <span>정책자금지원센터 | 업무협약 세진컴퍼니</span>
            </a>
          </div>
        </div>
        ...
        <div className="sejin-footer-bottom">
          <p className="sejin-footer-copyright">
            &copy; 2026 세진컴퍼니. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
