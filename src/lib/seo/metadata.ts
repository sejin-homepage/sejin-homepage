...
export const pageMetadata: Record<string, Metadata> = {
  home: {
    title: '세진컨설팅 | 중소기업 정책자금·벤처인증 전문 컨설팅',
    description:
      '중소기업 정책자금 전문 컨설팅 세진컨설팅. 저금리 정책자금 조달, 벤처인증, 이노비즈 인증까지 기업 역량을 분석해 맞춤 자금조달 전략을 설계합니다. 무료 기업진단으로 시작하세요.',
    keywords:
      '정책자금, 중소기업 정책자금, 자금조달, 정부지원금, 창업자금, 운전자금, 시설자금, 세진컨설팅, 벤처인증, 이노비즈, 경영컨설팅',
    openGraph: {
      title: '세진컨설팅 | 중소기업 정책자금·벤처인증 전문 컨설팅',
      description:
  ...
  certification: {
    title: '벤처인증·이노비즈 기업인증 컨설팅 | 세진컨설팅',
    description:
  ...
  success: {
    title: '정책자금 성공사례 | 중소기업 자금조달 실적 - 세진컨설팅',
    description:
      '세진컨설팅의 418건 이상 정책자금 성공사례. 96% 심사 통과율, 평균 2.8억 자금조달. 다양한 업종의 실제 중소기업 성공사례를 확인하세요.',
    keywords:
      '정책자금 성공사례, 중소기업 자금조달, 컨설팅 성공률, 정책자금 후기, 세진컨설팅 실적',
    openGraph: {
      title: '정책자금 성공사례 | 중소기업 자금조달 실적 - 세진컨설팅',
      description:
