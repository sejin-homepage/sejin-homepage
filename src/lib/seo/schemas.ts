...
export function localBusinessSchema() {
  return {
    ...
    telephone: PHONE,
    description:
      '세진컨설팅은 중소기업 정책자금 전문 컨설팅 기업입니다. 기업 역량 분석부터 맞춤형 자금조달 전략 수립까지 체계적 지원을 제공합니다.',
    priceRange: '무료 기업진단',
    address: {
      '@type': 'PostalAddress',
      addressCountry: 'KR',
...
export function faqSchema() {
  const faqs = [
    {
      q: '세진컨설팅의 중소기업 정책자금 컨설팅 차별점은 무엇인가요?',
    ...
    },
    {
      ...
      a: '초기 기업진단과 역량 분석은 전액 무료로 진행됩니다. 본격적인 컨설팅 수수료는 지원 프로젝트의 성격과 난이도를 고려하여 산정되며, 직접 방문상담을 통해 맞춤형 견적을 제공해드립니다.',
    },
    {
      q: '정책자금 접수부터 최종 지급까지 소요 기간은 어느 정도인가요?',
      a: '사업 유형별로 차이가 있으나 긴급운전자금은 3-4주 내, 일반 정책자금은 2-3개월 수준입니다. 세진컨설팅은 최대 지원금액, 유리한 금리조건, 장기 상환조건 확보에 집중합니다.',
    },
    {
      q: '정책자금 수령 이후에도 지속적인 사후관리를 받을 수 있나요?',
      a: '세진컨설팅은 장기적 성장 파트너를 지향합니다. 자금 활용 모니터링, 후속 지원사업 추천, 추가 정책자금 조달 지원 등을 종합 제공합니다. 단발성 지원이 아닌 지속가능한 성장 기반을 함께 구축해나가겠습니다.',
    },
  ]
...
export function howToSchema() {
  return {
    ...
    description:
      '세진컨설팅의 중소기업 정책자금 자금조달 6단계 프로세스. 무료 기업진단부터 사후 관리까지 체계적으로 진행됩니다.',
    totalTime: 'P90D',
    step: [
      {
        '@type': 'HowToStep',
        position: 1,
        name: '무료 기업진단 접수',
        text: '전화(1877-0773) 또는 온라인으로 무료 기업진단을 접수합니다. 기업 현황과 필요 자금 규모를 간단히 알려주시면 됩니다.',
      },
      {
        '@type': 'HowToStep',
        position: 2,
