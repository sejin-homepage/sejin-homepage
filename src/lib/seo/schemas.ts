...
export function localBusinessSchema() {
  return {
    ...
    telephone: PHONE,
    description:
      '세진 컨설팅는 정책자금 전문 경영컨설팅 기업입니다. 대표자 역량 분석부터 맞춤형 자금 전략 수립까지 체계적 지원을 제공합니다.',
    priceRange: '무료 상담',
    address: {
      '@type': 'PostalAddress',
      addressCountry: 'KR',
...
export function faqSchema() {
  const faqs = [
    ...
    },
    {
      ...
      a: '사업 유형별로 차이가 있으나 긴급운전자금은 3-4주 내, 일반 정책자금은 2-3개월 수준입니다. 세진 컨설팅는 최대 지원금액, 유리한 금리조건, 장기 상환조건 확보에 집중합니다.',
    },
    {
      q: '자금 수령 이후에도 지속적인 관리를 받을 수 있나요?',
      a: '세진 컨설팅는 장기적 성장 파트너를 지향합니다. 자금 활용 모니터링, 후속 지원사업 추천, 추가 자금 조달 지원 등을 종합 제공합니다. 단발성 지원이 아닌 지속가능한 성장 기반을 함께 구축해나가겠습니다.',
    },
  ]
